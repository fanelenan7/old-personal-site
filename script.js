$(document).ready(() => {
  ...
  let descriptions = {
    ...
    skills: "<div class='description'><h3>Skills</h3><ul><li>JavaScript</li><li>Ruby</li><li>AngularJS</li><li>Express.js</li><li>Mongoose</li><li>Node.js</li><li>Rails</li><li>ReactJS</li><li>jQuery</li><li>HTML5</li><li>CSS3</li><li>Git</li><li>Sinatra</li><li>PostgreSQL</li></ul></div>",
